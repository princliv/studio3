...
abstract final class PostMaterialOptions {
  ...
  static const all = <PostMaterialOption>[
    ...
    PostMaterialOption(
      ...
      price: r'$19.80',
      imagePath: 'assets/post/grid/grid_01.jpg',
    ),
    PostMaterialOption(
      id: 'liquin_medium',
      name: 'Winsor & Newton Liquin Original Medium',
      price: r'$14.25',
      imagePath: 'assets/post/grid/grid_02.jpg',
    ),
    PostMaterialOption(
      id: 'canvas_panel',
      name: 'Fredrix Canvas Panel - 11 x 14 in',
      price: r'$8.99',
      imagePath: 'assets/post/grid/grid_03.jpg',
    ),
    PostMaterialOption(
      id: 'gesso_primer',
      name: 'Liquitex Professional Gesso - White',
      price: r'$16.50',
      imagePath: 'assets/post/grid/grid_04.jpg',
    ),
    PostMaterialOption(
      id: 'palette_knife',
      name: 'RGM New Age Painting Knife #045',
      price: r'$12.30',
      imagePath: 'assets/post/grid/grid_05.jpg',
    ),
    PostMaterialOption(
      id: 'charcoal_set',
      name: 'General\'s Charcoal Pencil Set - 12 Pack',
      price: r'$11.75',
      imagePath: 'assets/post/grid/grid_06.jpg',
    ),
    PostMaterialOption(
      id: 'watercolor_paper',
      name: 'Arches Watercolor Block - Cold Press 140 lb',
      price: r'$32.00',
      imagePath: 'assets/post/grid/grid_07.jpg',
    ),
    PostMaterialOption(
      id: 'brush_set',
      name: 'Princeton Velvetouch Brush Set - 5 Piece',
      price: r'$24.60',
      imagePath: 'assets/post/grid/grid_08.jpg',
    ),
    PostMaterialOption(
      id: 'fixative_spray',
      name: 'Grumbacher Final Fixative - Matte',
      price: r'$9.45',
      imagePath: 'assets/post/grid/grid_09.jpg',
    ),
  ];
